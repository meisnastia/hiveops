...
const COMMANDS = {
  ...
  experience: {
    output: [
      ...
      "",
      "── DevOps Engineer (Mentorship) ────── 2023 — Present",
      "   Under guidance of a Senior Platform Engineer",
      "   • Provisioned GCP infra for RAG pipeline (Vertex AI, Cloud Run, AlloyDB)",
      "   • Wrote Terraform modules for VPC, GKE, Cloud SQL, IAM",
      "   • Built CI/CD with GitHub Actions for infra + app deployment",
      "   • Configured monitoring & alerting for AI endpoints",
  ...
  projects: {
    output: [
      ...
      "",
      "3. Vertex RAG Platform                            [AI/MLOps]",
      "   Production-grade DevOps infra for RAG pipeline on GCP",
      "   Most complex project — full infra ownership under mentorship",
      "   → github.com/meisnastia/vertex-rag-infra",
      "",
      "4. HiveOps                                        [Platform]",
